...
public class BookmarkControllerTest {
    ...
    public void shouldGetBookmarks(int pageNo, int totalElement, int totalPages, int currentPage,
        ...
        mvc.perform(get("/api/bookmarks?page="+ pageNo))
                ...
                .andExpect(jsonPath("$.totalElements", CoreMatchers.equalTo(totalElement)))
